...
of scripts that work with this kind of data.

The Cluster object is format agnostic. This means that you can read any sort read in any format supported and
