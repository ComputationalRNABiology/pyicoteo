...
from pyicos.operations import (Turbomix, Extend, Poisson, RemoveRegion, RemoveChromosome, Normalize, Subtract,
...
class PicosParser:
    ...
    def __init__(self):
        ...
        span.add_argument('--span', default=25, help='The span of the variable and fixed wig formats')
        ...
        trim_percentage.add_argument('--trim', default=0.05, help='Fraction of the cluster height below which the peak is trimmed. Example: For a cluster of height 40, if the flag is 0.05, 40*0.05=2. Every cluster will be trimmed to that height. A position of height 1 is always considered insignificant, no matter what the cluster height is. [Default %(default)s]')
        ...
        #split operation
        subparsers.add_parser('split', help='Split the peaks in subpeaks. Only accepts pk or wig as output (other formats under development).', parents=[parserinput, output, output_flags, round, span, label])
        #discard operation
        ...
        parser.set_defaults(discard = None, output=None, control=None, label = 'noname', output_format=PK, open_output =False,  rounding = False,
                            ...
                            frag_size = None, tag_length = None, span=40, p_value=0.01, height_limit=100, correction=1, no_subtract = False, normalize = False, trim=0.05,
                            open_control=False, no_sort=False, duplicates=4, threshold=None)
        ...
        turbomix = Turbomix(args.input, args.output, args.input_format, args.output_format, args.label, args.open_input, args.open_output, args.debug,
                            ...
                            args.region_format, args.open_region, args.span, args.frag_size, args.p_value, args.height_limit, args.correction, args.trim,
                            args.no_sort, args.duplicates, args.threshold)
