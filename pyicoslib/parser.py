...
class PicosParser:
    ...
    def create_parser(self):
        ...
        total_reads_flags.add_argument('--total-reads-replica', type=int, default=0, help="To manually set how many reads the dataset in 'experiment_replica_a' has. If not used, it will be calculated from the read or the counts file. Default %(default)s (not used)")
